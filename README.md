...
| --- | --- | --- | --- | --- | --- | --- |
| Forecasting | RNN | LSTM-AD [1]([1]) | Un | P | Point |
...
## References
[1] Pankaj Malhotra, Lovekesh Vig, Gautam Shroff, Puneet Agarwal, et al . 2015. Long short term memory networks for anomaly detection in time
